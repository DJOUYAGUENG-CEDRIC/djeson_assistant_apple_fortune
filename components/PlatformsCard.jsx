  ...
  return (
    <div className="px-3 pt-3 pb-1">
      <div
        ...
        style={{ background: '#1c0e05', border: '1px solid #3d1f08' }}
      >
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {PLATFORMS.map((p) => (
            <div
              ...
              style={{ background: '#2a1505', border: '1px solid #7c2d12' }}
            >
              <a
                href={p.url}
                target="_blank"
              ...
              {p.code && (
                <>
                  ...
                  <button
                    ...
                    style={{ color: copiedName === p.name ? '#f59e0b' : '#a16207' }}
        ...
        <div className="flex items-center gap-2 pt-2" style={{ borderTop: '1px solid #3d1f08' }}>
