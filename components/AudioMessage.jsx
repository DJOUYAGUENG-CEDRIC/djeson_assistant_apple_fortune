...
export default function AudioMessage({ src }) {
  ...
  const trackBg  = `linear-gradient(to right, #f59e0b ${progress}%, #3d1f08 ${progress}%)`;

  return (
    <div className="flex justify-start">
      <div
        className="rounded-2xl px-3 py-3 w-72 shadow-sm"
        style={{ background: '#1c0e05', border: '1px solid #3d1f08', borderTopLeftRadius: '4px' }}
      >
        ...
        <div className="flex items-center gap-1.5 mb-2.5">
          <div className="rounded-full p-1 shrink-0" style={{ background: '#dc2626', color: '#fff' }}>
            <MicIcon />
          </div>
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div className="flex-1 flex flex-col gap-1 min-w-0">
            ...
            />
            <div className="flex justify-between text-xs tabular-nums" style={{ color: '#a16207' }}>
          ...
          <button
            ...
            style={{ color: '#f59e0b', background: '#2a1505' }}
